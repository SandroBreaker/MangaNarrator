...
export const NarrativeViewport: React.FC<Props> = ({ unit, isLoading }) => {
  if (isLoading) {
    return (
  ...
  return (
    <article className="w-full space-y-6" aria-live="polite">
      <div className="relative group overflow-hidden rounded-2xl border-4 border-slate-800 bg-black">
        <img 
          src={unit.imageUrl} 
      ...
      <div className="bg-slate-900 border-l-8 border-sky-500 p-8 rounded-r-xl shadow-2xl">
        <h3 className="text-slate-400 text-xs font-bold uppercase tracking-widest mb-2">Narração Atual</h3>
        <p className="text-3xl font-bold leading-relaxed text-slate-50 selection:bg-sky-500/30">
